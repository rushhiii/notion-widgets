...
export default function Hero() {
  return (
    <section className="max-w-6xl mx-auto px-6 py-20 text-center">
      ...
      <MP initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.2 }} className="mt-6 text-lg text-slate-300 max-w-3xl mx-auto">
      ...
      <MD className="mt-10 flex items-center justify-center gap-4" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.35 }}>
